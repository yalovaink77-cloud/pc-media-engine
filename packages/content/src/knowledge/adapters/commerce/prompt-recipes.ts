...
export const COMMERCE_PROMPT_CONTENT_RECIPES: readonly PromptContentRecipeDefinition[] = [
  ...
  defineRecipe({
    ...
    contentObjective:
      'Write an educational, non-promotional product review that separates verified structured facts, manufacturer positioning, professional guidance, and uncertainty. Help readers understand formulation, evidence/guideline alignment, practical fit, and when to seek professional advice.',
    sectionOrder: [
      'content-objective',
      'product-overview',
      'brand-context',
